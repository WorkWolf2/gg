...
public class ManageCitiesCommand implements SubCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        plugin.getMenuManager().openManageCitiesMenu(target, 0);
    }
    ...
    public String getDescription() {
        return "Manage Cities Command";
    }

    @Override
    public String getUsage() {
        return "/hnations managecities <player>";
    }
}
